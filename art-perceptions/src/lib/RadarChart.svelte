<script lang="ts">
    ...
    function RadarChart(id, data, options) {
        var cfg = {
            ...
            levels: data.length, //How many levels or inner circles should there be drawn
    ...
    onMount(() => {
        ...
        var color = d3.scaleOrdinal().range(["#f29e5a", "#3e01b4", "#00A0B0"]);
