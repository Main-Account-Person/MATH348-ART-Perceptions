...
<script lang="ts">
    ...
    const surveyQuestions: { question: String; responseValue: Number[] }[] = [
        ...
        {
            question:
                "How aesthetically pleasing do you find this piece to be?",
            responseValue: [5],
        },
        {
            question:
...
<main>
    ...
    <body>
        <div class="ArtInfoCard">
            <img src={artObject.Images[0].ImagePath} alt="Image" />
            <h1>{artObject.Disp_Title}</h1>
            <h4>by {artObject.Disp_Maker_1}</h4>
        </div>
...
<style>
    ...
    main {
        background-image: url("../../../../images/ab4.jpeg");
